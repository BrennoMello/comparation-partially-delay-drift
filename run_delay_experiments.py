    ...
    for learning_algorithm in learning_algorithms:
        for size in data_stream:
            for drift_algorithm in drift_detectors_params:
                for data_delay in size["data_delay"]:
                    for iter in range(repetitions):
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_agraw1/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_AGRAW1_Abrupt.csv'
                            else:
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                            -s (ConceptDriftStream -s (generators.AgrawalGenerator -i {iter}) -d (ConceptDriftStream \
                                            -s (generators.AgrawalGenerator -i {iter} -f 2) -d (ConceptDriftStream \
                                            -s (generators.AgrawalGenerator -i {iter} -f 3) -d (ConceptDriftStream \
                                            -s (generators.AgrawalGenerator -i {iter} -f 4) -d (generators.AgrawalGenerator -i {iter} -f 5) \
                            ...
                            command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d {drift_algorithm["drift_name"]}) \
                                        -s (ConceptDriftStream -s (generators.AgrawalGenerator -i {iter}) -d (ConceptDriftStream \
                                        -s (generators.AgrawalGenerator -i {iter} -f 2) -d (ConceptDriftStream \
                                        -s (generators.AgrawalGenerator -i {iter} -f 3) -d (ConceptDriftStream \
                                        -s (generators.AgrawalGenerator -i {iter} -f 4) -d (generators.AgrawalGenerator -i {iter} -f 5) \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_agraw1/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_AGRAW1_Gradual.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_agraw2/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_AGRAW2_Abrupt.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):                                            
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 500) \
                                        -p {size["drift_position"][1]} -w 500) \
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_agraw2/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_AGRAW2_Gradual.csv'
                            else:
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                        -s (ConceptDriftStream -s (generators.AgrawalGenerator -i {iter} -f 6) -d (ConceptDriftStream \
                                        -s (generators.AgrawalGenerator -i {iter} -f 7) -d (ConceptDriftStream \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_led/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_LED_Abrupt.csv'  
                            else:     
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                        -s (ConceptDriftStream -s (generators.LEDGeneratorDrift -i {iter}) -d (ConceptDriftStream \
                                        -s (generators.LEDGeneratorDrift -i {iter} -d 7) -d (ConceptDriftStream \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                            ...
                                            -p {size["drift_position"][2]} -w 500) \
                                            -p {size["drift_position"][1]} -w 500) \
                                            -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_led/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_LED_Gradual.csv'    
                            else: 
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                            -s (ConceptDriftStream -s (generators.LEDGeneratorDrift -i {iter} -d 7) -d (ConceptDriftStream \
                                            -s (generators.LEDGeneratorDrift -i {iter} -d 7) -d (ConceptDriftStream \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_mixed/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_MIXED_Abrupt.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 500) \
                                        -p {size["drift_position"][1]} -w 500) \
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_mixed/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_MIXED_Gradual.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_randomRBF/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_RANDOM_RBF_Abrupt.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 500) \
                                        -p {size["drift_position"][1]} -w 500) \
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_randomRBF/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_RANDOM_RBF_Gradual.csv'
                            else:
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                        -s (ConceptDriftStream -s (generators.RandomRBFGeneratorDrift -i {iter} -c 6 -a 40 -n 50 -r 1) -d (ConceptDriftStream \
                                        -s (generators.RandomRBFGeneratorDrift -i {iter} -c 6 -a 40 -n 50 -r 2) -d (ConceptDriftStream \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_sine/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_SINE_Abrupt.csv'
                            else:    
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l (moa.classifiers.drift.DetectionConceptDriftMethodClassifier -l {learning_algorithm} -d ({drift_algorithm["drift_name"]} {drift_algorithm["params"]})) \
                                        -s (ConceptDriftStream -s (generators.SineGenerator -i {iter}) -d (ConceptDriftStream \
                                        -s (generators.SineGenerator -i {iter} -f 2) -d (ConceptDriftStream \
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 500) \
                                        -p {size["drift_position"][1]} -w 500) \
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_sine/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_SINE_Gradual.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 1) \
                                        -p {size["drift_position"][1]} -w 1) \
                                        -p {size["drift_position"][0]} -w 1) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/abrupt_waveform/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_WAVEFORM_Abrupt.csv'
                        ...
                        if(drift_algorithm["params"] != ""):
                            if(drift_algorithm["id"] == "Studd" or drift_algorithm["id"] == "MultivariateDetector"):
                                command = f'java -cp moa/src/moa-2023.04.0-sources.jar -javaagent:moa/lib/sizeofag-1.0.4.jar -classpath "moa/lib/*" moa.DoTask "EvaluatePrequentialDelayedConceptDrift -l ({drift_algorithm["drift_name"]} {drift_algorithm["params"]}) \
                                        ...
                                        -p {size["drift_position"][2]} -w 500) \
                                        -p {size["drift_position"][1]} -w 500) \
                                        -p {size["drift_position"][0]} -w 500) -e (BasicPartiallyLabeledConceptDriftPerformanceEvaluator) -i {size["data_size"]} -f 1000 -k {data_delay} -p 1000 -m -z {iter}" > results/delay/gradual_waveform/{learning_algorithm}_{drift_algorithm["id"]}_{size["data_size"]}_{data_delay}_{iter}_WAVEFORM_Gradual.csv'
