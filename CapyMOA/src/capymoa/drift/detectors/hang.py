...
from .meta_add_components.DriftDetector_CNN import Detector
#from DriftDetector_RNN import Detector


class Hang(BaseDriftDetector):

    def __init__(self, the_k=25, compare_window_len=1275, detector="CNN"):
        super().__init__()
        self.the_k = the_k
    ...
    def get_params(self) -> Dict[str, Any]:
        ...
        return {
            "compare_window_len": self.compare_window_len,
            "the_k": self.the_k,
        }

    def add_element(self, prediction: float | np.ndarray) -> None:
